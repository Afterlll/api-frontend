...
/** listInvokeTOPNCount GET /api/interfaceInfo/listInvokeTOPNCount */
export async function listInvokeTopnCountUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseobject>('/api/interfaceInfo/listInvokeTOPNCount', {
    method: 'GET',
    ...(options || {}),
  });
}
